"""
test_system_post.py --- 由 yaml-to-pytest skill 自动生成，请勿手动修改
...
def test_TC_POST_001(module_context, request_helper):
    """GET /system/post/list_正常分页查询_返回岗位列表含address字段"""
...
def test_TC_POST_002(module_context, request_helper):
    """GET /system/post/list_无效分页参数_返回错误码500"""
...
def test_TC_POST_003(module_context, request_helper):
    """GET /system/post/{postId}_查询存在的岗位_返回岗位详情含address字段"""
...
def test_TC_POST_004(module_context, request_helper):
    """GET /system/post/{postId}_查询不存在的岗位_返回错误码500"""
...
def test_TC_POST_005(module_context, request_helper):
    """GET /system/post/optionselect_按部门筛选岗位_返回岗位选择列表含address字段"""
...
def test_TC_POST_006(module_context, request_helper):
    """GET /system/post/optionselect_查询不存在的岗位ID_返回空列表"""
